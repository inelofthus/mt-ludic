 ...
 * </p>
 * <ul>
 *   <li>{@link pghttptest.Root#getAs <em>As</em>}</li>
 *   <li>{@link pghttptest.Root#getB <em>B</em>}</li>
 * </ul>
 *
...
public class Root extends MinimalEObjectImpl.Container implements EObject {
	...
	protected EClass eStaticClass() {
		return PghttptestPackage.Literals.ROOT;
	}

	/**
	 * Returns the value of the '<em><b>As</b></em>' containment reference list.
	 * The list contents are of type {@link pghttptest.A}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see pghttptest.PghttptestPackage#getRoot_As()
	 ...
	 * @see #setB(B)
	 * @see pghttptest.PghttptestPackage#getRoot_B()
	 * @model containment="true"
	 * @generated
	 */
	public B getB() {
	...
	/**
	 * Sets the value of the '{@link pghttptest.Root#getB <em>B</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setB(B newB) {
		if (newB != b) {
			...
			if (b != null)
				msgs = ((InternalEObject)b).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PghttptestPackage.ROOT__B, null, msgs);
			if (newB != null)
				msgs = ((InternalEObject)newB).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PghttptestPackage.ROOT__B, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PghttptestPackage.ROOT__AS:
				return ((InternalEList<?>)getAs()).basicRemove(otherEnd, msgs);
			case PghttptestPackage.ROOT__B:
