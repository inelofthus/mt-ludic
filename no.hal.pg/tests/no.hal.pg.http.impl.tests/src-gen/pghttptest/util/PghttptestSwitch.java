 ...
 * @generated
 */
public class PghttptestSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PghttptestPackage modelPackage;
	 ...
	 * @generated
	 */
	public PghttptestSwitch() {
		if (modelPackage == null) {
			modelPackage = PghttptestPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PghttptestPackage.ROOT: {
				Root root = (Root)theEObject;
				T result = caseRoot(root);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PghttptestPackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PghttptestPackage.B: {
				B b = (B)theEObject;
				T result = caseB(b);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PghttptestPackage.C: {
				C c = (C)theEObject;
				T result = caseC(c);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PghttptestPackage.D: {
				D d = (D)theEObject;
				T result = caseD(d);
				if (result == null) result = caseC(d);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PghttptestPackage.PRIV: {
