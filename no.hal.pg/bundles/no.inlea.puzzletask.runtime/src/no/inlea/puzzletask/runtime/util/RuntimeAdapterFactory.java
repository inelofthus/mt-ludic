...
public class RuntimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected RuntimeSwitch<Adapter> modelSwitch =
		new RuntimeSwitch<Adapter>() {
			@Override
			public Adapter casePuzzleTask(PuzzleTask object) {
				return createPuzzleTaskAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseSimplePuzzle(SimplePuzzle object) {
				return createSimplePuzzleAdapter();
			}
			@Override
			public Adapter casePlayerTaskScore(PlayerTaskScore object) {
				return createPlayerTaskScoreAdapter();
			}
			@Override
			public Adapter casePlayerTaskScores(PlayerTaskScores object) {
				return createPlayerTaskScoresAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.PuzzleTask <em>Puzzle Task</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPuzzleTaskAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.PuzzlePiece <em>Puzzle Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.PuzzleTaskView <em>Puzzle Task View</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.Puzzle <em>Puzzle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.SimplePuzzle <em>Simple Puzzle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSimplePuzzleAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.PlayerTaskScore <em>Player Task Score</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPlayerTaskScoreAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.inlea.puzzletask.runtime.PlayerTaskScores <em>Player Task Scores</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPlayerTaskScoresAdapter() {
		return null;
	}
