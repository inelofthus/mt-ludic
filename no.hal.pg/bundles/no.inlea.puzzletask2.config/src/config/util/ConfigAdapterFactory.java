...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter casePuzzleTask2Config(PuzzleTask2Config object) {
				return createPuzzleTask2ConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link config.PuzzleTask2Config <em>Puzzle Task2 Config</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPuzzleTask2ConfigAdapter() {
		return null;
	}
