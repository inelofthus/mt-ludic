...
public class ConfigSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigPackage.PUZZLE_TASK2_CONFIG: {
				PuzzleTask2Config puzzleTask2Config = (PuzzleTask2Config)theEObject;
				T1 result = casePuzzleTask2Config(puzzleTask2Config);
				if (result == null) result = caseTaskConfig(puzzleTask2Config);
				if (result == null) result = caseAbstractConfig(puzzleTask2Config);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Puzzle Task2 Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Puzzle Task2 Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 casePuzzleTask2Config(PuzzleTask2Config object) {
		return null;
	}
