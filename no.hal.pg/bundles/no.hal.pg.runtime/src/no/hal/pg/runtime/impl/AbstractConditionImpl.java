...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Predicate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.runtime.impl.AbstractConditionImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractConditionImpl<E> extends MinimalEObjectImpl.Container implements AbstractCondition<E> {
	...
	public E getContext() {
		if (context != null && ((EObject)context).eIsProxy()) {
			...
			context = (E)eResolveProxy(oldContext);
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RuntimePackage.ABSTRACT_CONDITION__CONTEXT, oldContext, context));
			}
		}
		return context;
	}
	...
	public void setContext(E newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.ABSTRACT_CONDITION__CONTEXT, oldContext, context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RuntimePackage.ABSTRACT_CONDITION__CONTEXT:
