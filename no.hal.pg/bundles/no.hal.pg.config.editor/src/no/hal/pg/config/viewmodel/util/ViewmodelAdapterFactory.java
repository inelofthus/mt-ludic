...
public class ViewmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ViewmodelSwitch<Adapter> modelSwitch =
		new ViewmodelSwitch<Adapter>() {
			@Override
			public Adapter caseBooleanComboRendererConfig(BooleanComboRendererConfig object) {
				return createBooleanComboRendererConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.pg.config.viewmodel.BooleanComboRendererConfig <em>Boolean Combo Renderer Config</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBooleanComboRendererConfigAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.spi.model.VAttachment <em>Attachment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
