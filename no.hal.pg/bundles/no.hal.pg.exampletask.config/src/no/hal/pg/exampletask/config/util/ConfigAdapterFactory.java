/**
 */
package no.hal.pg.exampletask.config.util;

import no.hal.pg.config.AbstractConfig;
import no.hal.pg.config.TaskConfig;

import no.hal.pg.exampletask.config.*;
...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter caseExampleTaskConfig(ExampleTaskConfig object) {
				return createExampleTaskConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.pg.exampletask.config.ExampleTaskConfig <em>Example Task Config</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExampleTaskConfigAdapter() {
		return null;
	}
