...
public class ConfigSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigPackage.EXAMPLE_TASK_CONFIG: {
				ExampleTaskConfig exampleTaskConfig = (ExampleTaskConfig)theEObject;
				T1 result = caseExampleTaskConfig(exampleTaskConfig);
				if (result == null) result = caseTaskConfig(exampleTaskConfig);
				if (result == null) result = caseAbstractConfig(exampleTaskConfig);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Example Task Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Example Task Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseExampleTaskConfig(ExampleTaskConfig object) {
		return null;
	}
