 ...
 * </p>
 * <ul>
 *   <li>{@link no.inlea.puzzletask3.runtime.Puzzle#getSolution <em>Solution</em>}</li>
 *   <li>{@link no.inlea.puzzletask3.runtime.Puzzle#getInstructions <em>Instructions</em>}</li>
 *   <li>{@link no.inlea.puzzletask3.runtime.Puzzle#getPuzzlePieces <em>Puzzle Pieces</em>}</li>
 *   <li>{@link no.inlea.puzzletask3.runtime.Puzzle#getPlayerPieces <em>Player Pieces</em>}</li>
 *   <li>{@link no.inlea.puzzletask3.runtime.Puzzle#getActivePlayers <em>Active Players</em>}</li>
 * </ul>
 *
 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle()
 * @model
 * @generated
 */
public interface Puzzle extends EObject {
	 ...
	 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle_Instructions()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link no.inlea.puzzletask3.runtime.Puzzle#getInstructions <em>Instructions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle_Solution()
	 * @model
	 * @generated
	 */
	String getSolution();
	...
	/**
	 * Sets the value of the '{@link no.inlea.puzzletask3.runtime.Puzzle#getSolution <em>Solution</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link no.inlea.puzzletask3.runtime.PuzzlePiece}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Puzzle Pieces</em>' containment reference list.
	 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle_PuzzlePieces()
	 ...
	 * and the value is of type {@link no.inlea.puzzletask3.runtime.PuzzlePiece},
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Player Pieces</em>' map.
	 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle_PlayerPieces()
	 * @model mapType="no.inlea.puzzletask3.runtime.PlayerToPuzzlePiece&lt;no.hal.pg.runtime.Player, no.inlea.puzzletask3.runtime.PuzzlePiece&gt;"
	 * @generated
	 */
	 ...
	 * @see no.inlea.puzzletask3.runtime.RuntimePackage#getPuzzle_ActivePlayers()
	 * @model
	 * @generated
	 */
