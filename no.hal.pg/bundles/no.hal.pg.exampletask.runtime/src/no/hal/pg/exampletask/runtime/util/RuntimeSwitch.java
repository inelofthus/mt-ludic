...
public class RuntimeSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RuntimePackage.EXAMPLE_TASK: {
				ExampleTask exampleTask = (ExampleTask)theEObject;
				T1 result = caseExampleTask(exampleTask);
				if (result == null) result = caseResettableTask(exampleTask);
				if (result == null) result = caseTask(exampleTask);
				if (result == null) result = caseDescribed(exampleTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RuntimePackage.EXAMPLE_TASK_VIEW: {
				ExampleTaskView exampleTaskView = (ExampleTaskView)theEObject;
				T1 result = caseExampleTaskView(exampleTaskView);
				if (result == null) result = caseTaskView(exampleTaskView);
				if (result == null) result = caseView1(exampleTaskView);
				if (result == null) result = caseView(exampleTaskView);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Example Task</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Example Task</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseExampleTask(ExampleTask object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Example Task View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Example Task View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseExampleTaskView(ExampleTaskView object) {
		return null;
	}
