...
public class ConfigSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigPackage.PUZZLE_TASK3_CONFIG: {
				PuzzleTask3Config puzzleTask3Config = (PuzzleTask3Config)theEObject;
				T1 result = casePuzzleTask3Config(puzzleTask3Config);
				if (result == null) result = caseTaskConfig(puzzleTask3Config);
				if (result == null) result = caseAbstractConfig(puzzleTask3Config);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Puzzle Task3 Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Puzzle Task3 Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 casePuzzleTask3Config(PuzzleTask3Config object) {
		return null;
	}
