...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter casePuzzleTask3Config(PuzzleTask3Config object) {
				return createPuzzleTask3ConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link config.PuzzleTask3Config <em>Puzzle Task3 Config</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPuzzleTask3ConfigAdapter() {
		return null;
	}
