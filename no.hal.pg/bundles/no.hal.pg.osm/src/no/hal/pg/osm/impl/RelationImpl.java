 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.osm.impl.RelationImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationImpl extends OSMElementImpl implements Relation {
	/**
	...
	protected EClass eStaticClass() {
		return OsmPackage.Literals.RELATION;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OsmPackage.RELATION__MEMBERS:
