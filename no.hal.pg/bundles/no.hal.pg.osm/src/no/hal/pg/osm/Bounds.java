 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.osm.Bounds#getMinLatitute <em>Min Latitute</em>}</li>
 *   <li>{@link no.hal.pg.osm.Bounds#getMinLongitude <em>Min Longitude</em>}</li>
 *   <li>{@link no.hal.pg.osm.Bounds#getMaxLatitude <em>Max Latitude</em>}</li>
 *   <li>{@link no.hal.pg.osm.Bounds#getMaxLongitude <em>Max Longitude</em>}</li>
 * </ul>
 *
 * @see no.hal.pg.osm.OsmPackage#getBounds()
 * @model
 * @generated
 */
public interface Bounds extends GeoLocated {
	 ...
	 * @see no.hal.pg.osm.OsmPackage#getBounds_MinLatitute()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.osm.Bounds#getMinLatitute <em>Min Latitute</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see no.hal.pg.osm.OsmPackage#getBounds_MinLongitude()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.osm.Bounds#getMinLongitude <em>Min Longitude</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see no.hal.pg.osm.OsmPackage#getBounds_MaxLatitude()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.osm.Bounds#getMaxLatitude <em>Max Latitude</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see no.hal.pg.osm.OsmPackage#getBounds_MaxLongitude()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.osm.Bounds#getMaxLongitude <em>Max Longitude</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
