 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.osm.Note#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @see no.hal.pg.osm.OsmPackage#getNote()
 * @model
 * @generated
 */
public interface Note extends EObject {
	 ...
	 * @see no.hal.pg.osm.OsmPackage#getNote_Contents()
	...
	/**
	 * Sets the value of the '{@link no.hal.pg.osm.Note#getContents <em>Contents</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
