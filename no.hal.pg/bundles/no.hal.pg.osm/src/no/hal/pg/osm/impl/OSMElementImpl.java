 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.osm.impl.OSMElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMElementImpl#isVisible <em>Visible</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMElementImpl#getTimestamp <em>Timestamp</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMElementImpl#getUser <em>User</em>}</li>
