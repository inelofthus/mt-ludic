 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getWays <em>Ways</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getRelations <em>Relations</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getBounds <em>Bounds</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getGenerator <em>Generator</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getMetaData <em>Meta Data</em>}</li>
 *   <li>{@link no.hal.pg.osm.impl.OSMImpl#getCopyright <em>Copyright</em>}</li>
 * </ul>
 *
 * @generated
 */
