...
public class ConfigUtil {
	...
	public static LeaderboardGame createGame(GameConfig config, Collection<Player> players) {
		LeaderboardGame game = IneruntimeFactory.eINSTANCE.createLeaderboardGame();
