 ...
 * </p>
 * <ul>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getContent <em>Content</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getScore <em>Score</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getTaskLocation <em>Task Location</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#isIsCompletedByPlayer <em>Is Completed By Player</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#isActive <em>Active</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getInstructions <em>Instructions</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getCloseTime <em>Close Time</em>}</li>
 *   <li>{@link no.inlea.puzzletask2.runtime.impl.PuzzleTaskViewImpl#getNumberOfActivePlayers <em>Number Of Active Players</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PuzzleTaskViewImpl extends TaskViewImpl<PuzzleTask2> implements PuzzleTaskView {
	/**
	...
	public boolean isActive() {
		PuzzleTask2 task = this.getModel();
	...
	public TaskView<?> start() {
		if (acceptPlayer()) {
			((PuzzleTask2)getModel()).start(getUser());
			return this;
		} else {
