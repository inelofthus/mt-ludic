...
public class RuntimeSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RuntimePackage.PUZZLE_TASK2: {
				PuzzleTask2 puzzleTask2 = (PuzzleTask2)theEObject;
				T1 result = casePuzzleTask2(puzzleTask2);
				if (result == null) result = caseTask(puzzleTask2);
				if (result == null) result = caseGeoLocation(puzzleTask2);
				if (result == null) result = caseDescribed(puzzleTask2);
				if (result == null) result = caseGeoLocated(puzzleTask2);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Puzzle Task2</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Puzzle Task2</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 casePuzzleTask2(PuzzleTask2 object) {
		return null;
	}
